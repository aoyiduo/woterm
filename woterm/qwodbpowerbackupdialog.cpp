...
#include "ui_qwodbpowerbackupdialog.h"
...
QWoDbPowerBackupDialog::QWoDbPowerBackupDialog(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::QWoDbPowerBackupDialog)
{
...
QWoDbPowerBackupDialog::~QWoDbPowerBackupDialog()
{
    delete ui;
}

void QWoDbPowerBackupDialog::onCurrentIndexChanged()
{
...
void QWoDbPowerBackupDialog::onAdjustLayout()
{
    adjustSize();
}

void QWoDbPowerBackupDialog::onSftpDetailButtonClicked()
{
...
void QWoDbPowerBackupDialog::onFileSaveClicked()
{
...
void QWoDbPowerBackupDialog::onFileUploadClicked()
{
...
void QWoDbPowerBackupDialog::onFileBrowserClicked()
{
...
void QWoDbPowerBackupDialog::onInfoArrived(int action, int err, const QString &errDesc)
{
    ui->info->setText(errDesc);
}

void QWoDbPowerBackupDialog::resetSftpUrl()
{
